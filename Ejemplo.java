...
public class Ejemplo {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("Valor short " + fooShort);
        // Integer - Entero complemento a dos con signo de 32-bit
        // (-2,147,483,648 <= int <= 2,147,483,647)
        int fooInt = 1;
        System.out.println("Valor int " + fooInt);
        ...
        System.out.println("Valor long " + fooLong);
        ...
        System.out.println("Valor float " + fooFloat);
        // Double - Número de coma flotante IEEE 754 de precisión doble de 64-bit
        double fooDouble = 123.4;
        System.out.println("Valor double " + fooDouble);
        // Boolean - true & false
